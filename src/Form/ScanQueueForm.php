...
/**
 * @file
 * Contains \Drupal\charitystock\Form\ScanQueueForm.
 */
...
class ScanQueueForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $queue = $this->queueFactory->get('manual_charitystock');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    while($item = $queue->claimItem()) {
      try {
        ...
        watchdog_exception('charitystock', $e);
      }
    }
  }
